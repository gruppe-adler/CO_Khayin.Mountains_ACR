...
onLoadName = "Khayin";                                                   //Name der Mission
onLoadMission = "Die Taliban planen, ein Treffen zwischen der ANA und der russischen Armee für einen Angriff auszunutzen...";                                 //Beschreibung der Mission (wird im Ladebildschirm unterhalb des Ladebildes angezeigt)
loadScreen = "data\taliban.paa";                                                //Ladebild
