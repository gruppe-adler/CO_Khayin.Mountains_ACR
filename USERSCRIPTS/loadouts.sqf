_loadoutFactionBlu = "";                                                 //Partei, dessen Standardloadout die Bluforspieler bekommen
_loadoutFactionOpf = "";                                                        //Partei, dessen Standardloadout die Opforspieler bekommen
_loadoutFactionInd = "Taliban";                                                        //Partei, dessen Standardloadout die Independentspieler bekommen
